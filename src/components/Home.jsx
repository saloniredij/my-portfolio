...
const headshotUrl = `${base}saloni-headshot.png`;   // when you re-enable the image
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/saloni-redij/',
      label: 'LinkedIn',
      icon: (
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/saloniredij',
      label: 'GitHub',
      icon: (
        <svg className="social-icon social-icon-large" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'LeetCode',
      url: 'https://leetcode.com/u/saloniredij/',
      label: 'LeetCode',
      icon: (
  ...
  return (
    <section id="home" className="home-section">
      <div className="home-container">
        ...
        {/* Right side - Introduction and Links */}
        <div className="home-content">
          <h1 className="home-greeting">
            Hi <span className="wave-emoji">👋</span>, I'm <span className="name-highlight">Saloni Redij</span>
          </h1>
          
          <p className="home-subtitle">
            Software Engineer | AI enthusiast | Social Volunteer
          </p>
